      ...
      <nav className="border-b border-gray-200 bg-white sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center gap-2.5">
          ...
          <svg width="32" height="32" viewBox="0 0 200 200" aria-hidden="true">
            <g fill="none" stroke="#BB0000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path fill="#BB0000" d="M100,18 C75,25 60,40 55,55 C40,60 30,72 28,82 C26,95 35,105 45,108 C40,118 48,128 58,132 C55,142 65,150 78,152 C85,158 95,160 100,158 C105,160 115,158 122,152 C135,150 145,142 142,132 C152,128 160,118 155,108 C165,105 174,95 172,82 C170,72 160,60 145,55 C140,40 125,25 100,18 Z M92,142 L92,175 C92,182 88,188 82,192 L118,192 C112,188 108,182 108,175 L108,142 Z" />
            <circle fill="#BB0000" cx="100" cy="105" r="5" />
            <circle fill="#BB0000" cx="96" cy="101" r="2" />
            <g fill="none" stroke="#BB0000" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
